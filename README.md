...
Com a tabela final (anatel_scm_2024.csv) foram criados em powerbi 7 dashboards, um para cada município selecionado exibidos no documento **MVP_Anatel_2024_BI.pdf**.
